exports.seed = function( knex, Promise ) {
	...
	return knex( 'authors' ).del()
        ...
        knex( 'authors' ).insert( {
					...
					imgurl: "https://s3-us-west-2.amazonaws.com/assessment-images/galvanize_reads/photos/alex_martelli.jpg"
				} ),
        knex( 'authors' ).insert( {
					id: 2,
					Fname: 'Anna',
					...
					imgurl: 'https://s3-us-west-2.amazonaws.com/assessment-images/galvanize_reads/photos/anna_ravenscroft.jpg'
				} ),
        knex( 'authors' ).insert( {
					id: 3,
					Fname: 'Steve',
					...
					imgurl: 'https://s3-us-west-2.amazonaws.com/assessment-images/galvanize_reads/photos/steve_holden.jpg'
				} ),
				knex( 'authors' ).insert( {
					id: 4,
					Fname: 'Allen B.',
					...
					imgurl: "https://s3-us-west-2.amazonaws.com/assessment-images/galvanize_reads/photos/allen_downey.jpg"
				} ),
				knex( 'authors' ).insert( {
					id: 5,
					Fname: 'Bonnie',
					...
					imgurl: "https://s3-us-west-2.amazonaws.com/assessment-images/galvanize_reads/photos/bonnie_eisenman.jpg"
				} ),
				knex( 'authors' ).insert( {
					id: 6,
					Fname: 'Kyle',
					...
					imgurl: "https://s3-us-west-2.amazonaws.com/assessment-images/galvanize_reads/photos/kyle_simpson.jpg"
				} )
      ] );
		} );
};
